...
**To Do List** In this project, I build a minimalist to-do agenda. Functions: Add tasks | Modify tasks | Remove tasks | Delete completed tasks.
...
**``https://github.com/mdg0410/react_todolist.git``**

2. Navigate to the location of the folder in your machine:

**`` C:\Users\PATH\src\react_todolist>``**
...
```bash
git clone https://github.com/mdg0410/react_todolist.git
```
...
Feel free to check the [issues page](https://github.com/mdg0410/react_todolist/issues)
